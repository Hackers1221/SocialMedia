                    ...
                    <div className="flex flex-col h-full justify-between overflow-y-auto overflow-x-hidden flex-grow">
                        <ul className="flex flex-col py-4 space-y-1">
                            ...
                            <li onClick={() => {setIsOpen(false); setMenuOpen(false); setSelected('Feed')}}>
                                <Link to="/" className={`relative border-l-4 hover:border-[var(--buttons)] flex flex-row items-center h-11 hover:text-[var(--buttons)] hover:shadow-md font-semibold border-l-4 pr-6 ${location.pathname === '/' ? `border-[var(--buttons)] text-[var(--buttons)] shadow-md` : `border-transparent text-[var(--text)]`}`}>
                            ...
                            <Link to="/explore" className={`relative border-l-4 hover:border-[var(--buttons)] flex flex-row items-center h-11 hover:text-[var(--buttons)] hover:shadow-md font-semibold border-l-4 pr-6 ${location.pathname === '/explore' ? `border-[var(--buttons)] text-[var(--buttons)] shadow-md` : `border-transparent text-[var(--text)]`}`}>
                            ...
                            <div onClick={openPulse} className={`relative border-l-4 hover:border-[var(--buttons)] flex flex-row items-center h-11 hover:cursor-pointer hover:text-[var(--buttons)] hover:shadow-md font-semibold border-l-4 pr-6 ${location.pathname.split("/")[1] === 'pulse' ? `border-[var(--buttons)] text-[var(--buttons)] shadow-md` : `border-transparent text-[var(--text)]`}`}>
                            ...
                            <li onClick={() => {setIsOpen(false); setMenuOpen(false); setSelected('Messages')}}>
                                <Link to="/message" className={`relative border-l-4 hover:border-[var(--buttons)] flex flex-row items-center h-11 hover:text-[var(--buttons)] hover:shadow-md font-semibold border-l-4 pr-6 ${location.pathname === '/message' ? `border-[var(--buttons)] text-[var(--buttons)] shadow-md` : `border-transparent text-[var(--text)]`}`}>
                            ...
                            <li onClick={async () => {
                                ...
                                <Link to="/notification" className={`relative flex flex-row hover:border-[var(--buttons)] items-center h-11 hover:text-[var(--buttons)] hover:shadow-md font-semibold pr-4 border-l-4 pr-6 ${location.pathname == '/notification' ? `border-[var(--buttons)] text-[var(--buttons)] shadow-md` : `border-transparent text-[var(--text)]`}`}>
                            ...
                            <li onClick={() => {setIsOpen(false); setMenuOpen(false); setSelected('Saved')}}>
                                <Link to="/saved" className={`relative border-l-4 hover:border-[var(--buttons)] flex flex-row items-center h-11 hover:text-[var(--buttons)] hover:shadow-md font-semibold border-l-4 pr-6 ${location.pathname === '/saved' ? `border-[var(--buttons)] text-[var(--buttons)] shadow-md` : `border-transparent text-[var(--text)]`}`}>
                        ...
                        <ul className="flex flex-col py-4 space-y-1">
                            ...
                            <li onClick={() => {setMenuOpen (!menuOpen); setSelected('More')}}>
                                <div className={`relative border-l-4 hover:border-[var(--buttons)] hover:cursor-pointer flex flex-row items-center h-11 hover:text-[var(--buttons)] hover:shadow-md font-semibold border-l-4 pl-4 ${selected === 'More' || location.pathname === '/settings' ? `border-[var(--buttons)] text-[var(--buttons)] shadow-md` : `border-transparent text-[var(--text)]`}`}>
