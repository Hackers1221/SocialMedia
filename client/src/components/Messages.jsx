function Messages () {
    return (
        <section className={`fixed top-[2rem] md:top-[1rem] right-[1rem] hidden md:flex md:flex-col overflow-auto w-full lg:max-w-sm bg-[${_COLOR.card}] rounded-md`}>
            <div className="search-box p-4 flex-none">
                <form>
                    <div className="relative">
                        <label>
                            <input className={`rounded-full py-2 pr-6 pl-10 w-full border border-[${_COLOR.input}] bg-transparent focus:outline-none text-[${_COLOR.text}] focus:shadow-md`}
                                type="text"  placeholder="Search Messages..."/>
                            <span className="absolute top-0 left-0 mt-2 ml-3 inline-block">
                            <i className={`fa-solid fa-magnifying-glass text-[${_COLOR.text}]`}></i>
                            </span>
                        </label>
                    </div>
                </form>
            ...
            <div className={`flex justify-between items-center p-3 rounded-lg relative text-[${_COLOR.text}]`}>
                    <div className="w-16 h-16 relative flex flex-shrink-0">
                        <img className="shadow-md rounded-full w-full h-full object-cover"
                            src="https://t4.ftcdn.net/jpg/03/83/25/83/360_F_383258331_D8imaEMl8Q3lf7EKU2Pi78Cn0R7KkW9o.jpg"
                            alt=""
