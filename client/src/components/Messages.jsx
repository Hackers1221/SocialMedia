            ...
            <div className="search-box p-4 flex-none">
                <form>
                    <div className="relative">
                        <label>
                            <input className={`rounded-full py-2 pr-6 pl-10 w-full border border-gray-800 focus:border-gray-700 bg-[${_COLOR.medium}] focus:outline-none text-gray-200 focus:shadow-md`}
