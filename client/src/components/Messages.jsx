function Messages () {
    return (
        <section className={`fixed top-[2rem] md:top-[1rem] right-[6rem] hidden md:flex md:flex-col overflow-auto w-[20rem] lg:max-w-sm bg-transparent rounded-md border-[1px] border-[${_COLOR.more_light}]`}>
            <div className="search-box p-4 flex-none">
                <form>
                    <div className="relative">
                        <label>
                            <input className={`rounded-full py-2 pr-6 pl-10 w-full border border-gray-800 focus:border-gray-700 bg-[${_COLOR.less_light}] focus:outline-none text-gray-200 focus:shadow-md`}
