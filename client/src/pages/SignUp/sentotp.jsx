...
function SendOtp() {
  ...
  return (
    <div
      className={`flex items-center justify-center h-screen w-full px-5 sm:px-0 bg-[url("https://images.stockcake.com/public/2/9/c/29cc0acd-d266-46bf-b9b8-b5330cd2918b_large/greenery-on-wood-stockcake.jpg")]  bg-no-repeat bg-cover bg-center`}
    >
      <div
      ...
      >
        <div className="flex justify-evenly w-full h-[80%]">
          ...
          <div className="flex flex-col items-center h-full justify-center">
            ...
            <div className="flex flex-col r py-5 overflow-hidden max-w-md w-full">
              <div className="w-full px-8 py-4">
                <p className="text-[3rem] text-white text-center font-bold">
                  Enter Your Email
                </p>
                <div className="mt-4">
